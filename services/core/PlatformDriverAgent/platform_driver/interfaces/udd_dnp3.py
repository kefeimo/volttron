...
class UserDevelopRegisterBitcoinRestAPI(WrapperRegister):
    ...
    def get_register_value(self) -> RegisterValue:
        ...
        result = self.master_application.retrieve_all_obj_by_gvids(gv_ids=[opendnp3.GroupVariationID(30, 6),
                                                                      opendnp3.GroupVariationID(1, 2)])
        print(f"===important log: case4 retrieve_all_obj_by_gvids default ==== ", datetime.datetime.now(),
              result)
